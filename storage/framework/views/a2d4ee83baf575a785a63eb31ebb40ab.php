...
} elseif ($_instance->childHasBeenRendered('suuJpaz')) {
    $componentId = $_instance->getRenderedChildComponentId('suuJpaz');
    $componentTag = $_instance->getRenderedChildComponentTagName('suuJpaz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('suuJpaz');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('suuJpaz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://www.flunzo.com/in/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('HW1dlMx')) {
    $componentId = $_instance->getRenderedChildComponentId('HW1dlMx');
    $componentTag = $_instance->getRenderedChildComponentTagName('HW1dlMx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HW1dlMx');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('HW1dlMx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('TrW73U5')) {
    $componentId = $_instance->getRenderedChildComponentId('TrW73U5');
    $componentTag = $_instance->getRenderedChildComponentTagName('TrW73U5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TrW73U5');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('TrW73U5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\flunzo\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>
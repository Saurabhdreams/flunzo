...
} elseif ($_instance->childHasBeenRendered('l2463816570-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2463816570-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2463816570-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2463816570-1');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('l2463816570-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l2463816570-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2463816570-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2463816570-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2463816570-2');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('l2463816570-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l2463816570-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2463816570-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2463816570-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2463816570-3');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('l2463816570-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l2463816570-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l2463816570-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2463816570-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2463816570-4');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('l2463816570-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>
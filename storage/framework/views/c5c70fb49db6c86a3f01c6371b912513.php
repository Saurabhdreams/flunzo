...
<div>
    ...
    <?php if($label): ?>
        <label for="text-input-component-id-<?php echo e($model, false); ?>" class="block text-sm font-medium tracking-wide <?php echo e($errors->first($model) ? 'text-red-600 dark:text-red-500' : 'text-gray-600 dark:text-white', false); ?>"><?php echo $label; ?></label>
    <?php endif; ?>
...
</div><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/components/forms/text-input.blade.php ENDPATH**/ ?>
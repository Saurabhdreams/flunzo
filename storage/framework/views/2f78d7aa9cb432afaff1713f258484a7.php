...
} elseif ($_instance->childHasBeenRendered('l2211847806-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2211847806-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2211847806-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2211847806-0');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.overview', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2211847806-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l2211847806-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2211847806-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2211847806-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2211847806-1');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.pricing', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2211847806-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l2211847806-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2211847806-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2211847806-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2211847806-2');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.requirements', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2211847806-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l2211847806-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2211847806-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2211847806-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2211847806-3');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2211847806-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
</div><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/seller/gigs/options/edit.blade.php ENDPATH**/ ?>
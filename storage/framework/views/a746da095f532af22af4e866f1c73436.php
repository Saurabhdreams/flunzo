...
} elseif ($_instance->childHasBeenRendered('l2730515404-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2730515404-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2730515404-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2730515404-0');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l2730515404-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes(['id' => 'modals-share-container','target' => 'modals-share-btn','uid' => 'modal_'.e(uid(), false).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <div class="items-center justify-center md:flex md:space-y-0 space-y-4">
                ...
                <div class="grid items-center justify-center mx-4">
                    <a href="https://twitter.com/intent/tweet?text=<?php echo e($gig->title, false); ?>%20-%20<?php echo e(url('service', $gig->slug), false); ?>%20" target="_blank" class="inline-flex justify-center items-center h-12 w-12 border border-transparent rounded-full bg-black focus:outline-none focus:ring-0 mx-auto">
                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="19" height="24" fill="white"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                    </a>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>
				...
				<form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							class="<?php echo e($errors->first('fullname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300', false); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
							placeholder="<?php echo e(__('messages.t_enter_your_fullname'), false); ?>"
							name="fullname" 
							pattern="[A-Za-z\s]+"
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/auth/register.blade.php ENDPATH**/ ?>
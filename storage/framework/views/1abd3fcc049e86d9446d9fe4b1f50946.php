...
} elseif ($_instance->childHasBeenRendered('j5AcHeq')) {
    $componentId = $_instance->getRenderedChildComponentId('j5AcHeq');
    $componentTag = $_instance->getRenderedChildComponentTagName('j5AcHeq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('j5AcHeq');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('j5AcHeq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('YV0terw')) {
    $componentId = $_instance->getRenderedChildComponentId('YV0terw');
    $componentTag = $_instance->getRenderedChildComponentTagName('YV0terw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YV0terw');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('YV0terw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('s1J5OdQ')) {
    $componentId = $_instance->getRenderedChildComponentId('s1J5OdQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('s1J5OdQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s1J5OdQ');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('s1J5OdQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="home-hero-section">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                    <div class="w-full md:max-w-lg">
                        ...
                        <h1 class="text-center sm:ltr:text-left sm:rtl:text-right mt-4 text-xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-3xl lg:mt-6 xl:text-4xl" style="color: #fffff; font-size: 45px;">
                        ...
                        <div class="mt-10 sm:mt-12">
                            ...
                            ?>
                            <div class="hidden sm:flex items-center text-white font-semibold text-sm whitespace-nowrap" style="color: #fffff;">
                                <?php echo app('translator')->get('messages.t_popular_colon'); ?> 
                                <ul class="flex ltr:ml-3 rtl:mr-3" style="color: darkslategray;">
                                    <?php $__currentLoopData = $popular_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex ltr:mr-3 rtl:ml-3 whitespace-nowrap">
                                            <a href="<?php echo e(url('categories', $tag->slug), false); ?>" class="border-2 border-white rounded-[40px] bg-white hover:text-gray-700 transition-all duration-200 px-3 py-0.5 text-xs">
...
} elseif ($_instance->childHasBeenRendered('RkfVcpN')) {
    $componentId = $_instance->getRenderedChildComponentId('RkfVcpN');
    $componentTag = $_instance->getRenderedChildComponentTagName('RkfVcpN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RkfVcpN');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('RkfVcpN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://www.flunzo.com/in/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>
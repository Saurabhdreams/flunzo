                        ...
                        <div x-data="{ open: true }" class="py-3">
                            ...
                            <div class="pt-6 px-4" x-show="open" style="display: none;">
                                <div class="space-y-4">
                                    ...
                                    <div class="rounded-md shadow-sm -space-y-px">
                                        <div>
                                            <input type="number" wire:model.defer="min_price" minlength="1" min="1" pattern="\d+" title="Please enter a valid number." maxlength="999999999" max="999999999" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 dark:placeholder-gray-200 dark:text-gray-100 text-gray-900 rounded-t-md focus:outline-none focus:ring-primary-600 focus:border-primary-600 focus:z-10 sm:text-sm font-medium dark:bg-transparent dark:border-zinc-600" placeholder="<?php echo e(__('messages.t_min_price'), false); ?>">
                                        </div>
                                        <div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/vhosts/flunzo.com/httpdocs/in/resources/views/livewire/main/categories/category.blade.php ENDPATH**/ ?>
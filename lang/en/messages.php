<?php
    ...
    return [
        ...
        "t_fake_name_irman_norton"                                 => "Aanya Sharma",
        "t_i_am_a_designer"                                        => "I am a designer",
        "t_fake_name_alejandro_lee"                                => "Priya Patel",
        "t_i_am_a_developer"                                       => "I am a developer",
        "t_fake_name_elsa_king"                                    => "Sneha Rao",
        "t_i_am_a_writer"                                          => "I am a writer",
        "t_fake_name_herman_reese"                                 => "Aarav Mehta",
        "t_i_am_a_video_editor"                                    => "I am a video editor",
        "t_fake_name_sue_keller"                                   => "Rohan Desai",
        "t_i_am_a_musician"                                        => "I am a Musician",
        "t_buyer_stories"                                          => "Buyer stories",
        "t_buyer_story_1"                                          => "This freelancing platform connects me with top-notch talent effortlessly, making every project a success. Highly recommend!",
        "t_buyer_story_2"                                          => "Excellent user interface and a diverse talent pool—definitely my go-to site for all freelance needs!",
        "t_buyer_story_3"                                          => "This freelancing site has consistently delivered high-quality results for all my projects.",
        "t_fake_name_alex_saunders"                                => "Arjun Mehta",
        "t_fake_name_ricky_jones"                                  => "Ishani Patel",
        "t_fake_name_melissa_ross"                                 => "Neha Guha",

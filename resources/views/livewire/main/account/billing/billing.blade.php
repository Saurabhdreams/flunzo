                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <x-forms.text-input 
    								label="{{ __('messages.t_firstname') }} <span style='color: red;'>*</span>" 
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <x-forms.text-input 
                                    label="{{ __('messages.t_lastname') }}  <span style='color: red;'>*</span>" 
                            ...
                            <div class="col-span-12" wire:key="billing-address">
                                <x-forms.textarea 
                                    label="{{ __('messages.t_address') }} <span style='color: red;'>*</span>" 

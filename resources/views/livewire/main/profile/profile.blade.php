            ...
            <div class="-mx-6 -my-6 pb-8 pt-10 relative">
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="sharing-buttons flex flex-wrap -mx-1 justify-center mt-2">
                        ...
                        {{-- Twitter --}}
                        <a class="bg-black duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url={{ url('profile', $user->username) }}&amp;text={{ $user->fullname ? $user->fullname : $user->username }}" aria-label="Share on Twitter">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="white" class="w-4 h-4"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                        </a>

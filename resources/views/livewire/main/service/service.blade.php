    ...
    <x-forms.modal id="modals-share-container" target="modals-share-btn" uid="modal_{{ uid() }}" placement="center-center" size="max-w-2xl">
        ...
        <x-slot name="content">
            <div class="items-center justify-center md:flex md:space-y-0 space-y-4">
                ...
                {{-- Twitter --}}
                <div class="grid items-center justify-center mx-4">
                    <a href="https://twitter.com/intent/tweet?text={{ $gig->title }}%20-%20{{ url('service', $gig->slug) }}%20" target="_blank" class="inline-flex justify-center items-center h-12 w-12 border border-transparent rounded-full bg-black focus:outline-none focus:ring-0 mx-auto">
